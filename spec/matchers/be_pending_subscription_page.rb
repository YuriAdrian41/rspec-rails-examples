# It's important that the matcher is in a module and the module has an instance method that will be available to the specs.
# The module name here will need to match the module name in the configuration specified in spec/support/matchers.rb
module Matchers

  # This instance method is what will be called in the specs
  # e.g. expect(page).to be_pending_subscription_page
  # 
  # This method is made available thanks to the 'config.include Matchers ...' line in spec/support/matchers.rb
  ...
  class BePendingSubscriptionPage
    ...
    def matches?(actual_page)
      ...
      # pending_subscriptions_path is available here thanks to including ::Rails.application.routes.url_helpers in this class.
