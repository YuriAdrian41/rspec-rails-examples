...
# 3. Start using VCR. See example use in spec/jobs/headline_scraper_job_spec.rb. Cassettes will be stored as .yml files in cassette_library_dir specified above.
