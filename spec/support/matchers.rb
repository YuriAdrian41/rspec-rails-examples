...
# 
# 1. Create a file like this one you're reading spec/support/matchers.rb:
...
# 
# Each matcher class will need to be in a module called "Matchers" to work with the RSpec configuration specified above, see the spec/matchers directory for an example.
