...
# 
# 1. Puffing Billy depends on Capybara. Install Capybara as explained in spec/support/capybara.rb
# 
...
# 4. Configure cache to behave as required. See all available options at: https://github.com/oesmith/puffing-billy#caching
Billy.configure do |c|
  ...
  # 
  # Only set non_whitelisted_requests_disabled **temperarily** to false when first recording a 3rd party interaction. After the recording has been stored to cache_path, then set non_whitelisted_requests_disabled back to true
...
# 6. Start using Puffing Billy. See spec/features/share_page_spec.rb for an example, and find your cached responses in spec/support/http_cache/billy
